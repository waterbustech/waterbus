...
Map<String, String> english = {
  ...
  Strings.roomTitle: "Room Title",
  Strings.passwordOptional: "Password (optional)",
  Strings.maxParticipants: "Max Participants (optional)",
  Strings.nameOrTitleHint: "Name or title of the room.",
  Strings.passwordHint: "Optional room password for joining.",
  Strings.maxHint: "Useful for scaling and admission control.",
  Strings.roomTitleEmpty: "Room title cannot be empty.",
  Strings.roomType: "Room Type",
  Strings.videoConferencing: "Video Conferencing",
  Strings.liveStreaming: "Live Streaming",
  Strings.streamingProtocol: "Streaming Protocol",
