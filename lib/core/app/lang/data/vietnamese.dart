...
Map<String, String> vietnamese = {
  ...
  Strings.supportUs: "Ủng hộ Waterbus",
  ...
  Strings.roomTitle: "Tên phòng",
  Strings.passwordOptional: "Mật khẩu (tuỳ chọn)",
  Strings.maxParticipants: "Số người tham gia tối đa (tuỳ chọn)",
  Strings.nameOrTitleHint: "Tên hoặc tiêu đề của phòng.",
  Strings.passwordHint: "Mật khẩu phòng (nếu có).",
  Strings.maxHint: "Hữu ích cho việc scale và kiểm soát truy cập.",
  Strings.roomTitleEmpty: "Không được để trống tiêu đề phòng.",
  Strings.roomType: "Loại phòng",
  Strings.videoConferencing: "Họp video",
  Strings.liveStreaming: "Phát trực tiếp",
  Strings.streamingProtocol: "Giao thức phát",
