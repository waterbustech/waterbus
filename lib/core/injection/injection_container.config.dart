...
import '../../features/settings/themes/bloc/themes_bloc.dart' as _i14;
...
_i1.GetIt $initGetIt(
  ...
  gh.factory<_i14.ThemesBloc>(
      () => _i14.ThemesBloc(gh<_i11.ThemesDatasource>()));
  gh.factory<_i15.AuthBloc>(
      () => _i15.AuthBloc(gh<_i13.UserLocalDataSource>()));
  gh.factory<_i16.MeetingBloc>(() => _i16.MeetingBloc(
        gh<_i8.PipChannel>(),
        gh<_i9.MeetingLocalDataSource>(),
        gh<_i10.CallSettingsLocalDataSource>(),
      ));
  gh.factory<_i17.RecentJoinedBloc>(
      () => _i17.RecentJoinedBloc(gh<_i9.MeetingLocalDataSource>()));
  return getIt;
}
