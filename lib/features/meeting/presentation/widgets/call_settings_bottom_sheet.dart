                ...
                children: [
                  ...
                  CallSettingButton(
                    ...
                    color: isSubtitleEnabled
                        ...
                        : null,
                    onTap: () {
                      AppBloc.meetingBloc.add(const MeetingSubtitleToggled());
                    },
                  ),
                  if (meeting?.isHost ?? false)
                    CallSettingButton(
                      ...
                      onTap: () {
                        if (isRecording) {
                          AppBloc.meetingBloc.add(const MeetingRecordStoped());
                        } else {
                          AppBloc.meetingBloc.add(const MeetingRecordStarted());
                        }
                      },
                    ),
                  CallSettingButton(
