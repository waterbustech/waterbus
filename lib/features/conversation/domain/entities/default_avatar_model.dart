  ...
  factory DefaultAvatarModel.fromFullName(String fullName) {
    if (fullName.isEmpty) {
      return DefaultAvatarModel(
        keyword: '?',
        backgroundColor: ColorConstants.colorDefault,
      );
    }
    ...
    final gradientColors = ColorConstants.colorGradientsByInitial[firstInitial];
    final fallbackColor =
        ColorConstants.colorIntial[firstInitial] ?? ColorConstants.colorDefault;
