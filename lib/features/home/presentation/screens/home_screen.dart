...
import 'package:waterbus/features/home/presentation/screens/home_desktop_screen.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future<void> _handleCreateButtonPressed(
            ...
            contentBuilder: (_) => Scaffold(
              appBar: appBarTitleBack(
                ...
                actions: [
                  IconButton(
                    onPressed: () {
                      _handleCreateButtonPressed(context, Strings.recent);
                    },
                    icon: Icon(
                      PhosphorIcons.plus(),
  ...
  Widget _buildHeader(BuildContext context, String route) {
    ...
    switch (route) {
      case Strings.recent:
        return EnterRoomCodeField(
          margin: margin,
          hintTextContent: Strings.enterCodeToJoinMeeting.i18n,
          suffixWidget: context.isDesktop
              ? _buildCreateMeetingButton(context, route)
              : null,
          onTap: () {
            if (context.isMobile) {
  ...
  Widget _buildCreateMeetingButton(BuildContext context, String route) {
    return GestureWrapper(
      onTap: () {
        _handleCreateButtonPressed(context, route);
      },
      child: Container(
        width: 36.sp,
        height: 36.sp,
